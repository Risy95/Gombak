...
<a class=\"nav-link menu\" href=\"logout.php?pn=00\">
    ...
    <div><h2>                                                       <!--  szöveg  -->
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3">
                <acronym title="Csiperke"><img class="excellent" alt="csiperke1" src="kepek/csiperke1.jpg" height="150"/></acronym>
            </div>
            <div class="col-sm-6 col-lg-3">
                <acronym title="Déli tőkegomba"><img class="excellent" alt="delitoke1" src="kepek/delitoke1.jpg" height="150"/></acronym>
            </div>
            <div class="col-sm-6 col-lg-3">
                <acronym title="Csoportos pereszke"><img class="excellent" alt="csoppereszke1" src="kepek/csoppereszke1.jpg" height="150"/></acronym>
            </div>
            <div class="col-sm-6 col-lg-3">
